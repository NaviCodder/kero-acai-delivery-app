    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-acai-900 via-acai-800 to-acai-700 text-white">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          {/* Logo grande e central para mobile */}
          ...
          <p className="text-xl md:text-2xl text-purple-100 max-w-3xl mx-auto leading-relaxed">
            ...
            O sabor autêntico que você ama, agora com delivery express!
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
            <Button 
              size="lg" 
              className="bg-white text-acai-800 hover:bg-purple-50 font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-3xl transition-all transform hover:scale-105 text-lg animate-pulse"
            >
          ...
          <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto pt-12">
            <div className="text-center p-4 bg-white/5 backdrop-blur-sm rounded-2xl hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
